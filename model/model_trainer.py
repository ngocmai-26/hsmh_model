...
class ModelTrainer:
    ...
    def optimize_hyperparameters(self, X, y, n_iter=20, cv=3, random_state=42):
        ...
        rf_param_grid = {
            ...
            'max_features': ['sqrt', 'log2', None],  # Removed 'auto' - use 'sqrt' instead for sklearn compatibility
        }
        gb_param_grid = {
            'n_estimators': [100, 200, 300, 400],
    ...
    def train_models(self, optimize_params=False):
        ...
        lr_params = {'max_iter': 5000, 'random_state': 42}  # Tăng từ 1000 lên 5000 để tăng độ chính xác
